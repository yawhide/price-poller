...
const fs = require("fs");
const log = require("debug")("price-poller:coingecko");
...
async function updateCoingeckoCacheAndDisk() {
  ...
  log("writing new coingecko price information to disk");
  fs.writeFile(
    ...
    (err) => {
      if (err) {
        ...
        log("updated coingecko prices:", lastUpdatedAt);
      }
...
module.exports.prices = coinPriceCache;
